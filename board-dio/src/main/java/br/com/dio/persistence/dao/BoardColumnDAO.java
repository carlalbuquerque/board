...
//requeredargsconstructor tbm poderia ser usado
...
public class BoardColumnDAO {
    ...
    public BoardColumnEntity insert(final BoardColumnEntity entity) throws SQLException {
        //numero de colunas e nome no meu banco
    ...
    public List<BoardColumnDTO> findByBoardIdWithDetail(final Long boardId) throws SQLException {
        ...
        try (var statement = connection.prepareStatement(sql)) {
            ...
            var resultSet = statement.executeQuery(); // Obtém o ResultSet diretamente
