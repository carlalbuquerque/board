...
public class CardService {
    ...
    public void moveCardToNextColumn(final long cardId, final List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException {
        try {
            ...
            var nextColumn = boardColumnsInfo.stream()
                    ...
                    .findFirst()
                    .orElseThrow(() -> new IllegalStateException("Não há uma próxima coluna disponível"));
    ...
    public void cancel(final long cardId, final long cancelColumnId,
        ...
        try {
            ...
            if (currentColumn.kind().equals(FINAL)) {
                throw new CardFinishedException("O card está finalizado e não pode ser cancelado.");
            }
    ...
    public void unblock(final Long id, final String reason) throws SQLException {
        try {
            ...
            if (!dto.blocked()) {
                var message = "o card %s não foi encontrado".formatted(id);
                throw new CardBlockedException(message);
